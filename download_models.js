...
// Promisify execFile to prevent shell injection risks
// Use execFile instead of exec when executing binaries to avoid shell interpretation of arguments like paths
const execFilePromise = (command, args) => {
